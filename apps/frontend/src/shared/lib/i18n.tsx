...
const enUS = {
  ...
  'transactions.bulkDeleteError': 'Could not delete selected transactions.',
  'transactions.bulkDeletePartialError':
    'Some selected transactions could not be deleted.',
  ...
  'transactions.selection.summary': '{count} selected.',
  'transactions.selection.toggleAll': 'Toggle all transaction rows',
  'transactions.selection.toggleRow': 'Toggle transaction row',
  'transactions.selection.deleteSelected': 'Delete selected',
  'transactions.selection.deleteWarning':
    'Selected saved transactions will be permanently deleted.',
  'transactions.selection.cancelDelete': 'Cancel',
  'transactions.selection.confirmDelete': 'Confirm delete',
...
const ptBR: Record<TranslationKey, string> = {
  ...
  'transactions.bulkDeleteError': 'Não foi possível excluir as transações selecionadas.',
  'transactions.bulkDeletePartialError':
    'Algumas transações selecionadas não puderam ser excluídas.',
  ...
  'transactions.selection.summary': '{count} selecionadas.',
  'transactions.selection.toggleAll': 'Alternar todas as linhas de transações',
  'transactions.selection.toggleRow': 'Alternar linha de transação',
  'transactions.selection.deleteSelected': 'Excluir selecionadas',
  'transactions.selection.deleteWarning':
    'As transações salvas selecionadas serão excluídas permanentemente.',
  'transactions.selection.cancelDelete': 'Cancelar',
  'transactions.selection.confirmDelete': 'Confirmar exclusão',
